...
import { BsColumnsGap, BsCart3 } from 'react-icons/bs';
...
function Navbar({active, removeToken, style}) {
	...
	return (
		<header style={{background: `${active === 'home' && "transparent"}`, marginTop: style}}>
			...
			<nav ref={navRef}>
				<GoHome size={20} color={`${active === 'home' ? '#db2b39' : ""}`}/>
				<Link to="/" className={`${active === 'home' ? "active" : ""}`} style={{marginLeft: '5px'}}>Home</Link>

				<IoFastFoodOutline size={20} color={`${active === 'recipes' ? '#db2b39' : ""}`}/>
				<Link to="/recipes" className={`${active === 'recipes' ? "active" : ""}`} style={{marginLeft: '5px'}}>Recipes</Link>

				<BsColumnsGap size={15} color={`${active === 'collection' ? '#db2b39' : ""}`}/>
				<Link to="/collections" className={`${active === 'collection' ? "active" : ""}`} style={{marginLeft: '5px'}}>Collection</Link>

				<BsCart3 size={15} color={`${active === 'shop-list' ? '#db2b39' : ""}`}/>
				<Link to="/shop-list" className={`${active === 'shop-list' ? "active" : ""}`} style={{marginLeft: '5px'}}>Shop List</Link>
